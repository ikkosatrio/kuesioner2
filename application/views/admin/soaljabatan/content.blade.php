...
@section('content')
	<div class="content-wrapper">
				...
				<div class="page-header page-header-default">
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li><a href="{{base_url('superuser/soaljabatan/?id_soal='.$soal->id_soal)}}">Jabatan</a></li>
				...
				<div class="content">
					...
					<div class="panel panel-flat">
						...
						<form id="form-blog" class="form-horizontal" action="{{ ($type=='create') ? base_url('superuser/soaljabatan/created') : base_url('superuser/jabatan/updated/'.$jabatan->id_jabatan) }}" method="post">
							<div class="form-group">
								<label class="col-lg-2 control-label">Soal <span class="text-danger"><b>*</b></span></label>
								<div class="col-lg-10">
									<p>{{$soal->soal}}</p>
					...
					<div class="text-right">
							<button type="submit" class="btn btn-primary">{{ ($type=='create') ? 'Buat Soal' : 'Ubah Soal' }} <i class="icon-arrow-right14 position-right"></i></button>
							@if($type=="update")
	...
	$("#form-blog").submit(function(e){
			...
			.done(function(data){
				...
				function(){
					if(data.auth!=false){
						redirect("{{base_url('superuser/soaljabatan/?id_soal='.$soal->id_soal)}}");
						return;
					}
				});
			})
