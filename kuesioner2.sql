...
-- Dumping data for table kuesioner2.rekomendasi: ~0 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `soal` (
  ...
  PRIMARY KEY (`id_soal`)
) ENGINE=InnoDB AUTO_INCREMENT=37 DEFAULT CHARSET=latin1 COMMENT='''Efficiency'',''Error'',''Satisfaction'',''Learnability'',''Memorability''';

-- Dumping data for table kuesioner2.soal: ~3 rows (approximately)
/*!40000 ALTER TABLE `soal` DISABLE KEYS */;
INSERT INTO `soal` (`id_soal`, `id_kuesioner`, `soal`, `jenis`, `aspek`) VALUES
	(34, 1, 'asdasdasd', 'APO1', 'APO'),
	(35, 1, 'dss', 'DSS1', 'DSS'),
	(36, 1, 'hhgh', 'APO2', 'APO');
